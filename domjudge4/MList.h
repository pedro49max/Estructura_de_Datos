 ...
 *
 * NOTE: This version has reverse iterators, and therefore differs from the "official" one
 */
#ifndef __LIST_H
#define __LIST_H
...
public:
    ...
    */
    ...
    /**
     * Removes element at current position, and returns iterator to next element.
     ...
     * To be precise, inserts _just before_ current element. For example, give it = l.begin(),
